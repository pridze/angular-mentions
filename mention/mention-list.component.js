...
var MentionListComponent = (function () {
    ...
    MentionListComponent.prototype.position = function (nativeParentElement, iframe) {
        ...
        setTimeout(function () {
            var topPositionAdjustment = 12; // TODO: enable to set adjustment value when using this component
            var elementLeftTopCoordinate = coords.top - el.firstElementChild.clientHeight - topPositionAdjustment;
